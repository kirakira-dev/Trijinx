...
All updates to this Trijinx branch will be documented in this file.

## [1.3.2](<https://git.trijinx.app/trijinx/trijinx/-/releases/1.3.2>) - 2025-06-09

## [1.3.1](<https://git.trijinx.app/trijinx/trijinx/-/releases/1.3.1>) - 2025-04-23

## [1.2.86](<https://github.com/Trijinx/Stable-Releases/releases/tag/1.2.86>) - 2025-03-13

## [1.2.82](<https://web.archive.org/web/20250312010534/https://github.com/Trijinx/Trijinx/releases/tag/1.2.82>) - 2025-02-16

## [1.2.80-81](<https://web.archive.org/web/20250302064257/https://github.com/Trijinx/Trijinx/releases/tag/1.2.81>) - 2025-01-22

## [1.2.78](<https://web.archive.org/web/20250301174537/https://github.com/Trijinx/Trijinx/releases/tag/1.2.78>) - 2024-12-19

## [1.2.73-1.2.76](<https://web.archive.org/web/20250209202612/https://github.com/Trijinx/Trijinx/releases/tag/1.2.76>) - 2024-11-19
...
## [1.2.72](<https://git.trijinx.app/trijinx/trijinx/-/tags/1.2.72>) - 2024-11-03
PRs [#163](<https://web.archive.org/web/20241123015123/https://github.com/GreemDev/Trijinx/pull/163>), [#164](<https://web.archive.org/web/20250307192526/https://github.com/Trijinx/Trijinx/pull/164>), [#139](<https://web.archive.org/web/20250306123457/https://github.com/Trijinx/Trijinx/pull/139>)
### HLE:
...
## [1.2.69](<https://git.trijinx.app/trijinx/trijinx/-/tags/1.2.69>) - 2024-11-01
### Infra:
  - Compile the native libraries into the Trijinx executable.
...
## [1.2.67](<https://git.trijinx.app/trijinx/trijinx/-/tags/1.2.67>) - 2024-11-01
PRs [#36](<https://web.archive.org/web/20250306215917/https://github.com/Trijinx/Trijinx/pull/36>), [#135](<https://web.archive.org/web/20241122135125/https://github.com/GreemDev/Trijinx/pull/135>)
...
## [1.2.64](https://git.trijinx.app/trijinx/trijinx/-/tags/1.2.64) - 2024-10-30
PRs [#92](https://web.archive.org/web/20241118052724/https://github.com/GreemDev/Trijinx/pull/92), ~~[#96](https://github.com/GreemDev/Trijinx/pull/96)~~, ~~[#97](https://github.com/GreemDev/Trijinx/pull/97)~~,  [#101](https://web.archive.org/web/20250306223605/https://github.com/Trijinx/Trijinx/pull/101), ~~[#103](https://github.com/GreemDev/Trijinx/pull/103)~~
### GUI:
...
PRs ~~[#88](https://github.com/GreemDev/Trijinx/pull/88), [#87](https://github.com/GreemDev/Trijinx/pull/87)~~
### i18n:
- fr_FR:
...
## 1.2.57 - 2024-10-27
PRs ~~[#60](https://github.com/GreemDev/Trijinx/pull/60)~~, [#42](https://web.archive.org/web/20241126203614/https://github.com/GreemDev/Trijinx/pull/42)
### GUI:
...
## 1.2.44 - 2024-10-25
PR [#59](https://web.archive.org/web/20241125060420/https://github.com/GreemDev/Trijinx/pull/59)
### GUI:
...
Init function: [archive of github.com/MutantAura/Trijinx/commit/9cef4ceba40d66492ff775af793ff70e6e7551a9](https://web.archive.org/web/20241122193401/https://github.com/MutantAura/Trijinx/commit/9cef4ceba40d66492ff775af793ff70e6e7551a9)

Shader counter: ~~https://github.com/MutantAura/Trijinx/commit/67b873645fd593e83d042a77bf7ab12e5ec97357~~ Original commit has been lost
...
## 1.2.41 - 2024-10-24
PR ~~[#54](https://github.com/GreemDev/Trijinx/pull/54)~~
...
## 1.2.40 - 2024-10-23
PR ~~[#40](https://github.com/GreemDev/Trijinx/pull/40)~~
...
## 1.2.38 - 2024-10-23
PR [#51](https://web.archive.org/web/20241127022413/https://github.com/GreemDev/Trijinx/pull/51)
### i18n:
- zh_CH (Simplified Chinese): Add some missing translations.

## 1.2.37 - 2024-10-23
PR [#37](https://web.archive.org/web/20241123010103/https://github.com/GreemDev/Trijinx/pull/37)
...
## 1.2.36 - 2024-10-21
PR ~~[#30](https://github.com/GreemDev/Trijinx/pull/30)~~
### GUI:
...
## 1.2.35 - 2024-10-21
PR [#32](https://web.archive.org/web/20241127010942/https://github.com/GreemDev/Trijinx/pull/32)
### GUI:
...
## 1.2.34 - 2024-10-21
PR [#29](https://web.archive.org/web/20241125093029/https://github.com/GreemDev/Trijinx/pull/29)
### GUI:
...
## 1.2.29 - 2024-10-19
### GUI: 
- Remove references to trijinx.org in the localization files.
- Switch from downloading amiibo.trijinx.org to just referencing a file in the repo & images in the repo, under assets/amiibo.

This fork is now entirely independent of the existing Trijinx infrastructure, and as such the Amiibo features will continue to work in my version when they break in the mainline version.
...
### GUI:
- Remove OS-provided title bar and put the Trijinx logo next to "File" in the menu bar.
  - What was in the title bar, Trijinx version & current game information, is still visible by hovering the Trijinx icon.
...
- Removed Avalonia test release bundle, which was kept in Trijinx for the OG Avalonia testers. That doesn't apply to this fork, so it's removed. 

## 1.2.21 - 2024-10-11
### GUI/RPC: 
- Add game version string when hovering large image asset.
- Add version information about this fork to the Trijinx logo (big when in main menu, small when in game) when hovering.

## 1.2.20 - 2024-10-11
### MISC:
- Code cleanups & remove references to Trijinx Patreon & Twitter.
### GUI:
...
### GUI/INFRA/MISC:
- Remove GTK UI.
- Autoload DLC/Updates from dir ([#12](https://web.archive.org/web/20241127004005/https://github.com/GreemDev/Trijinx/pull/12)).
