...
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenBallot;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenCall;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenFSI;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenHelper;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenMemory;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenPacking;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenShuffle;
using static Trijinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenVector;
