...
namespace Trijinx.Ava.Systems.Configuration
{
    public class ConfigurationFileFormat
    {
        ...
        /// <summary>
        /// DEPRECATED: Checks for updates when Trijinx starts when enabled
        /// </summary>
        public bool CheckUpdatesOnStart { get; set; }

        /// <summary>
        /// Checks for updates when Trijinx starts when enabled, either prompting when an update is found or just showing a notification.
        /// </summary>
        ...
        /// <summary>
        /// Enable/disable the ability to control Trijinx when it's not the currently focused window.
        /// </summary>
