...
using Trijinx.HLE.HOS.SystemState;
using Trijinx.HLE.Loaders.Npdm;
using Trijinx.HLE.Loaders.Processes.Extensions;
using Trijinx.HLE.Utilities;
using System;
...
namespace Trijinx.Ava.Systems.AppLibrary
{
    public class ApplicationLibrary
    {
        ...
        public ApplicationLibrary(VirtualFileSystem virtualFileSystem, IntegrityCheckLevel checkLevel)
        {
            ...
            _nspIcon = EmbeddedResources.Read("Trijinx/Assets.UIImages.Icon_NSP.png");
            _xciIcon = EmbeddedResources.Read("Trijinx/Assets.UIImages.Icon_XCI.png");
            _ncaIcon = EmbeddedResources.Read("Trijinx/Assets.UIImages.Icon_NCA.png");
            _nroIcon = EmbeddedResources.Read("Trijinx/Assets.UIImages.Icon_NRO.png");
            _nsoIcon = EmbeddedResources.Read("Trijinx/Assets.UIImages.Icon_NSO.png");
        }

        /// <exception cref="Trijinx.HLE.Exceptions.InvalidNpdmException">The npdm file doesn't contain valid data.</exception>
