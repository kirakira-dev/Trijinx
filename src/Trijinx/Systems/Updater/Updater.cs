...
namespace Trijinx.Ava.Systems
{
    internal static partial class Updater
    {
        ...
        private static readonly string _updateDir = Path.Combine(Path.GetTempPath(), "Trijinx", "update");
        ...
        public static async Task BeginUpdateAsync(bool showVersionUpToDate = false)
        {
            ...
            await Dispatcher.UIThread.InvokeAsync(async () =>
            {
                ...
                UserResult shouldUpdate = await ContentDialogHelper.CreateUpdaterChoiceDialog(
                    LocaleManager.Instance[LocaleKeys.TrijinxUpdater],
                    LocaleManager.Instance[LocaleKeys.TrijinxUpdaterMessage],
                    newVersionString,
                ...
                {
                    case UserResult.Yes:
                        await UpdateTrijinx(_versionResponse.ArtifactUrl);
                        break;
                    default:
                        _running = false;
                        break;
        ...
        private static HttpClient ConstructHttpClient()
        {
            ...
            result.DefaultRequestHeaders.Add("User-Agent", $"Trijinx-Updater/{ReleaseInformation.Version}");

            return result;
        }

        private static async Task UpdateTrijinx(string downloadUrl)
        {
            ...
            {
                Header = LocaleManager.Instance[LocaleKeys.TrijinxUpdater],
                SubHeader = LocaleManager.Instance[LocaleKeys.UpdaterDownloading],
                IconSource = new SymbolIconSource { Symbol = Symbol.Download },
                ShowProgressBar = true,
                XamlRoot = TrijinxApp.MainWindow,
            };
            ...
            if (_updateSuccessful)
            {
                ...
                {
                    shouldRestart = await ContentDialogHelper.CreateChoiceDialog(LocaleManager.Instance[LocaleKeys.TrijinxUpdater],
                ...
                if (shouldRestart)
                {
                    ...
                    if (OperatingSystem.IsMacOS())
                    {
                        ...
                        string newBundlePath = Path.Combine(_updateDir, "Trijinx.app");
                    ...
                    else
                    {
                        ...
                        {
                            ryuName = OperatingSystem.IsWindows() ? "Trijinx.exe" : "Trijinx";
                        }
...
#pragma warning restore SYSLIB0014
        ...
        private static void DoUpdateWithSingleThreadWorker(TaskDialog taskDialog, string downloadUrl, string updateFile)
        {
            ...
            while (true)
            {
                ...
                TrijinxApp.SetTaskbarProgressValue(bytesWritten, totalBytes);
