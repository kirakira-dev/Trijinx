...
using Trijinx.Ava.Systems;
using Trijinx.Ava.Systems.Configuration;
using Trijinx.Ava.Systems.Configuration.System;
using Trijinx.Ava.UI.Helpers;
using Trijinx.Ava.UI.Windows;
using Trijinx.Ava.Utilities;
using Trijinx.Ava.Utilities.SystemInfo;
using Trijinx.Common;
using Trijinx.Common.Configuration;
using Trijinx.Common.GraphicsDriver;
using Trijinx.Common.Logging;
using Trijinx.Common.SystemInterop;
using Trijinx.Common.Utilities;
using Trijinx.Graphics.RenderDocApi;
using Trijinx.Graphics.Vulkan.MoltenVK;
using Trijinx.Headless;
using Trijinx.SDL3.Common;
using System;
    ...
    internal static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            if (OperatingSystem.IsWindows())
            {
                ...
                {
                    _ = Win32NativeInterop.MessageBoxA(nint.Zero, "Trijinx is not intended to be run from the Program Files folder. Please move it out and relaunch.", $"Trijinx {Version}", MbIconwarning);
                    return 0;
                }
                ...
                {
                    _ = Win32NativeInterop.MessageBoxA(nint.Zero, "Trijinx is not intended to be run as administrator.", $"Trijinx {Version}", MbIconwarning);
                    return 0;
                }
            }
            ...
            // TODO: Trijinx causes core dumps on Linux when it exits "uncleanly", eg. through an unhandled exception.
            ...
            if (noGuiArg)
            {
                HeadlessTrijinx.Entrypoint(args);
                return 0;
            }
        ...
        public static AppBuilder BuildAvaloniaApp() =>
            AppBuilder.Configure<TrijinxApp>()
                .UsePlatformDetect()
        ...
        {
            // Ensure Discord presence timestamp begins at the absolute start of when Trijinx is launched
            ...
            Console.Title = $"{TrijinxApp.FullAppName} Console {Version}";
        ...
        {
            Logger.Notice.Print(LogClass.Application,  " _____     _                       _           _       ");
            Logger.Notice.Print(LogClass.Application, @"|_   _| __(_)_   _ _ __ ___ __   _(_)_ __ __ _| |_ ___ ");
            Logger.Notice.Print(LogClass.Application, @"  | || '__| | | | | '_ ` _ \\ \ / / | '__/ _` | __/ _ \");
            Logger.Notice.Print(LogClass.Application, @"  | || |  | | |_| | | | | | |\ V /| | | | (_| | ||  __/");
            Logger.Notice.Print(LogClass.Application, @"  |_||_|  |_|\__,_|_| |_| |_| \_/ |_|_|  \__,_|\__\___|");


            Logger.Notice.Print(LogClass.Application, $"{TrijinxApp.FullAppName} Version: {Version}");
