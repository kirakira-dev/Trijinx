...
using Trijinx.Common.Configuration.Hid;
...
using Trijinx.HLE.HOS.Applets;
using Trijinx.HLE.HOS.Services.Account.Acc;
using Trijinx.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
using Trijinx.HLE.Loaders.Processes;
using Trijinx.HLE.UI;
using Trijinx.Input;
using Trijinx.Input.HLE;
using Trijinx.Input.SDL3;
...
using UserProfile = Trijinx.HLE.HOS.Services.Account.Acc.UserProfile;
using LibHac.Util;

namespace Trijinx.Headless
{
    abstract unsafe partial class WindowBase : IHostUIHandler, IDisposable
    {
        ...
        {
            Stream iconStream = EmbeddedResources.GetStream("Trijinx/Assets/UIImages/Logo_Trijinx.png");
        ...
        private void InitializeWindow()
        {
            ...
            SDL_SetStringProperty(props, SDL_PROP_WINDOW_CREATE_TITLE_STRING, $"Trijinx {Program.Version}{titleNameSection}{titleVersionSection}{titleIdSection}{titleArchSection}");
