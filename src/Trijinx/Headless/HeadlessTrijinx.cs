...
{
    public partial class HeadlessTrijinx
    {
        ...
        public static void Entrypoint(string[] args)
        {
            ...
            Console.Title = $"HeadlessTrijinx Console {Program.Version}";
        ...
        static void Load(string[] originalArgs, Options option)
        {
            ...
            _accountManager = new AccountManager(_libHacHorizonManager.TrijinxClient, option.UserProfile);
            ...
            if (!option.DisableFileLog)
            {
                ...
                {
                    Logger.Error?.Print(LogClass.Application, "No writable log directory available. Make sure either the Logs directory, Application Data, or the Trijinx directory is writable.");
                }
            }
