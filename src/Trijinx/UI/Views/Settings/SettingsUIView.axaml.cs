...
{
    public partial class SettingsUiView : TrijinxControl<SettingsViewModel>
    {
        ...
        private async Task AddDirButton(TextBox addDirBox, AvaloniaList<string> directories)
        {
            ...
            {
                Optional<IStorageFolder> folder = await TrijinxApp.MainWindow.ViewModel.StorageProvider.OpenSingleFolderPickerAsync();
