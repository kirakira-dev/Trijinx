...
using Trijinx.Input;
using Trijinx.Input.Assigner;
using Button = Trijinx.Input.Button;
using StickInputId = Trijinx.Common.Configuration.Hid.Controller.StickInputId;

namespace Trijinx.Ava.UI.Views.Input
{
    public partial class ControllerInputView : TrijinxControl<ControllerInputViewModel>
    {
