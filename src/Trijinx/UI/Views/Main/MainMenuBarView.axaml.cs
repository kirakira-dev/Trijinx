...
{
    public partial class MainMenuBarView : TrijinxControl<MainWindowViewModel>
    {
        ...
        public MainMenuBarView()
        {
            ...
            CloseTrijinxMenuItem.Command = Commands.Create(() => Window?.Close());
        ...
        {
            const string LanguagesPath = "Trijinx/Assets/Languages.json";
