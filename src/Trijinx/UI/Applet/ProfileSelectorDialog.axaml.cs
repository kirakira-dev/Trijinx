...
using UserProfileSft = Trijinx.HLE.HOS.Services.Account.Acc.UserProfile;

namespace Trijinx.Ava.UI.Applet
{
    public partial class ProfileSelectorDialog : TrijinxControl<ProfileSelectorDialogViewModel>
    {
