...
{
    public class TrijinxApp : Application
    {
        ...
        public static readonly string FullAppName = string.Intern(ReleaseInformation.IsCanaryBuild ? "Trijinx Canary" : "Trijinx");
        ...
        public override void Initialize()
        {
            ...
            if (OperatingSystem.IsMacOS())
            {
                ...
                Process.Start("/usr/bin/defaults", "write org.trijinx.Trijinx ApplePressAndHoldEnabled -bool false");
            }
        }
        ...
        public static ThemeVariant DetectSystemTheme() =>
            Current is TrijinxApp { PlatformSettings: not null } app
                ? ConvertThemeVariant(app.PlatformSettings.GetColorValues().ThemeVariant)
                : ThemeVariant.Default;

        private async void AboutTrijinx_OnClick(object sender, EventArgs e)
        {
