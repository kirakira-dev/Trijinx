...
using Trijinx.Ava.Systems.Configuration.UI;
using Trijinx.Ava.UI.Applet;
...
namespace Trijinx.Ava.UI.Windows
{
    public partial class MainWindow : StyleableAppWindow
    {
        ...
        public MainWindow() : base(useCustomTitleBar: true)
        {
            ...
            ViewModel.Title = TrijinxApp.FormatTitle();
        ...
        {
            if (Application.Current is TrijinxApp app)
        ...
        private void Initialize()
        {
            ...
            VirtualFileSystem.FixExtraData(LibHacHorizonManager.TrijinxClient);

            AccountManager = new AccountManager(LibHacHorizonManager.TrijinxClient, CommandLineState.Profile);

            VirtualFileSystem.ReloadKeySet();

            ApplicationHelper.Initialize(VirtualFileSystem, AccountManager, LibHacHorizonManager.TrijinxClient);
        }
        ...
        private static async Task ShowVmMaxMapCountDialog()
        {
            ...
            UserResult response = await ContentDialogHelper.ShowTextDialog(
                TrijinxApp.FormatTitle(LocaleKeys.LinuxVmMaxMapCountDialogTitle, false),
        ...
        private async Task CheckLaunchState()
        {
            ...
            switch (ConfigurationState.Instance.UpdateCheckerType.Value)
            {
                ...
                case UpdaterType.CheckInBackground:
                    ...
                    {
                        Dispatcher.UIThread.Post(() => TrijinxApp.MainWindow.ViewModel.UpdateAvailable = versions.Current < versions.Incoming);
                    }
