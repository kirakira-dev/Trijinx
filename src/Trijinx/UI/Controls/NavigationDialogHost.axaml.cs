...
using Trijinx.Ava.UI.Views.User;
...
using UserId = Trijinx.HLE.HOS.Services.Account.Acc.UserId;
using UserProfile = Trijinx.Ava.UI.Models.UserProfile;

namespace Trijinx.Ava.UI.Controls
{
    public partial class NavigationDialogHost : TrijinxControl<UserProfileViewModel>
    {
