...
using Trijinx.Common.Configuration.Hid.Controller.Motion;
...
using ConfigGamepadInputId = Trijinx.Common.Configuration.Hid.Controller.GamepadInputId;
using ConfigStickInputId = Trijinx.Common.Configuration.Hid.Controller.StickInputId;
using Key = Trijinx.Common.Configuration.Hid.Key;

namespace Trijinx.Ava.UI.ViewModels.Input
{
    public partial class InputViewModel : BaseModel, IDisposable
    {
        private const string Disabled = "disabled";
        private const string ProControllerResource = "Trijinx/Assets/Icons/Controller_ProCon.svg";
        private const string JoyConPairResource = "Trijinx/Assets/Icons/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "Trijinx/Assets/Icons/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "Trijinx/Assets/Icons/Controller_JoyConRight.svg";
        ...
        public InputViewModel(UserControl owner, bool useGlobal = false) : this()
        {
            ...
            {
                _mainWindow = TrijinxApp.MainWindow;
