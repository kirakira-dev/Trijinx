...
namespace Trijinx.Ava.UI.ViewModels
{
    public partial class SettingsViewModel : BaseModel
    {
        ...
        public bool IsScalingFilterActive => _scalingFilter == (int)Trijinx.Common.Configuration.ScalingFilter.Fsr;
        ...
        public void SaveSettings(bool global = false)
        {
            ...
            TrijinxApp.MainWindow.ViewModel.VSyncModeSettingChanged();
        ...
        public AsyncRelayCommand ResetButton => Commands.Create(async () =>
        {
            ...
            await ContentDialogHelper.CreateInfoDialog(
                $"Your {TrijinxApp.FullAppName} configuration has been reset.",
                "",
                string.Empty,
