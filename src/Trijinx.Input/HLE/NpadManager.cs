...
using CemuHookClient = Trijinx.Input.Motion.CemuHook.Client;
using ControllerType = Trijinx.Common.Configuration.Hid.ControllerType;
using PlayerIndex = Trijinx.HLE.HOS.Services.Hid.PlayerIndex;
using Switch = Trijinx.HLE.Switch;

namespace Trijinx.Input.HLE
{
