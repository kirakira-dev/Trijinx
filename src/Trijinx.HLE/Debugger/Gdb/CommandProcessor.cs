...
namespace Trijinx.HLE.Debugger.Gdb
{
        ...
        public void Process(string cmd)
        {
            ...
            switch (ss.ReadChar())
            {
                ...
                case 'q':
                    ...
                    {
                        Reply($"name:Trijinx;version:{ReleaseInformation.Version};");
                        break;
                    }
                    ...
                    if (ss.ConsumeRemaining("HostInfo"))
                    {
                        Reply(
                            Debugger.IsProcess32Bit
                                ? $"triple:{Helpers.ToHex("arm-unknown-linux-android")};endian:little;ptrsize:4;hostname:{Helpers.ToHex("Trijinx")};"
                                : $"triple:{Helpers.ToHex("aarch64-unknown-linux-android")};endian:little;ptrsize:8;hostname:{Helpers.ToHex("Trijinx")};");
