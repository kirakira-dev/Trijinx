...
using Trijinx.HLE.HOS.Services.Nifm.StaticService.GeneralService;
using Trijinx.HLE.HOS.Services.Nifm.StaticService.Types;
using System;
using System.Net.NetworkInformation;
using System.Runtime.CompilerServices;

namespace Trijinx.HLE.HOS.Services.Nifm.StaticService
{
    class IGeneralService : DisposableIpcService
    {
        ...
        public ResultCode GetCurrentNetworkProfile(ServiceCtx context)
        {
            ...
            "TrijinxNetwork"u8.CopyTo(networkProfile.Name.AsSpan());
