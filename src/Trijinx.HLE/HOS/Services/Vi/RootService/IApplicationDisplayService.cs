...
using Trijinx.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService;
using Trijinx.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService.Types;
using Trijinx.HLE.HOS.Services.Vi.Types;
...
namespace Trijinx.HLE.HOS.Services.Vi.RootService
{
