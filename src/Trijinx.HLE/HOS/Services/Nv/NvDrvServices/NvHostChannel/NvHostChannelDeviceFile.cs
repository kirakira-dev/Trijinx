...
using Trijinx.Graphics.Gpu.Memory;
using Trijinx.HLE.HOS.Services.Nv.NvDrvServices.NvHostChannel.Types;
...
namespace Trijinx.HLE.HOS.Services.Nv.NvDrvServices.NvHostChannel
{
