...
using Trijinx.Cpu;
using Trijinx.HLE.HOS.Services.Sockets.Nsd.Manager;
using Trijinx.HLE.HOS.Services.Sockets.Sfdnsres.Proxy;
using Trijinx.HLE.HOS.Services.Sockets.Sfdnsres.Types;
...
namespace Trijinx.HLE.HOS.Services.Sockets.Sfdnsres
{
    [Service("sfdnsres")]
