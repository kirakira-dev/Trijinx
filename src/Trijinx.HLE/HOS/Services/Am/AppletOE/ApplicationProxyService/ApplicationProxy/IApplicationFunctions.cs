...
using Trijinx.HLE.HOS.Services.Am.AppletAE.Storage;
using Trijinx.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
using Trijinx.HLE.HOS.Services.Sdb.Pdm.QueryService;
using Trijinx.HLE.HOS.SystemState;
using Trijinx.Horizon.Common;
using System;
using System.Numerics;
using System.Threading;
using AccountUid = Trijinx.HLE.HOS.Services.Account.Acc.UserId;
using ApplicationId = LibHac.Ncm.ApplicationId;

namespace Trijinx.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy
{
