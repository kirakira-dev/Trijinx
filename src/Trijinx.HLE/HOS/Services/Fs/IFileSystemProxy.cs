...
using Trijinx.HLE.HOS.Services.Fs.FileSystemProxy;
using Trijinx.Memory;
using System;
using System.IO;
using static Trijinx.HLE.Utilities.StringUtils;
using GameCardHandle = System.UInt32;
using IFile = Trijinx.HLE.HOS.Services.Fs.FileSystemProxy.IFile;
...
#pragma warning restore IDE0059
        ...
        public ResultCode OutputAccessLogToSdCard(ServiceCtx context)
        {
            ...
            // FS ends each line with a newline. Remove it because Trijinx logging adds its own newline
