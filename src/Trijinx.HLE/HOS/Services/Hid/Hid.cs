...
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.Common;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.DebugMouse;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.DebugPad;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.Keyboard;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.Mouse;
using Trijinx.HLE.HOS.Services.Hid.Types.SharedMemory.Npad;
