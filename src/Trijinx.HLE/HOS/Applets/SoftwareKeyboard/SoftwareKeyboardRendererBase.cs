...
namespace Trijinx.HLE.HOS.Applets.SoftwareKeyboard
{
    ...
    internal class SoftwareKeyboardRendererBase
    {
        ...
        private readonly SKBitmap _trijinxLogo = null;
        ...
        {
            int trijinxLogoSize = 32;

            string trijinxIconPath = "Trijinx.HLE.HOS.Applets.SoftwareKeyboard.Resources.Logo_Trijinx.png";
            _trijinxLogo = LoadResource(typeof(SoftwareKeyboardRendererBase).Assembly, trijinxIconPath, trijinxLogoSize, trijinxLogoSize);

            string padAcceptIconPath = "Trijinx.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnA.png";
            string padCancelIconPath = "Trijinx.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnB.png";
            string keyModeIconPath = "Trijinx.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_KeyF6.png";
        ...
        private void DrawImmutableElements()
        {
            ...
            canvas.DrawBitmap(_trijinxLogo, _logoPosition);
        ...
        private void ComputeConstants()
        {
            ...
            int logoPositionX = (totalWidth - _trijinxLogo.Width) / 2;
