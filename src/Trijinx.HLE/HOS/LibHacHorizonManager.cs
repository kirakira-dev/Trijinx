...
using Trijinx.HLE.HOS.Services.Arp;
using System;
...
namespace Trijinx.HLE.HOS
{
    public class LibHacHorizonManager
    {
        ...
        public HorizonClient TrijinxClient { get; private set; }
        ...
        private void InitializeServer()
        {
            ...
            TrijinxClient = Server.CreatePrivilegedHorizonClient();
        }

        public void InitializeArpServer()
        {
            _arpIReader.Reset(new LibHacIReader());
            TrijinxClient.Sm.RegisterService(new LibHacArpServiceObject(ref _arpIReader), "arp:r").ThrowIfFailure();
        }
