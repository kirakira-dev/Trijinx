...
namespace Trijinx.HLE.HOS.Kernel.Memory
{
    abstract class KPageTableBase
    {
        ...
        /// <exception cref="Trijinx.Memory.InvalidMemoryRegionException">Throw for unhandled invalid or unmapped memory accesses</exception>
