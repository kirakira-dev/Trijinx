                ...
                case CapabilityType.CorePriority:
                    {
                        ...
                        if (isApplication)
                            Trijinx.Common.Logging.Logger.Info?.Print(Trijinx.Common.Logging.LogClass.Application, $"Application requested cores with index range {lowestCpuCore} to {highestCpuCore}");
