...
using System;
using static Trijinx.Graphics.OpenGL.Effects.ShaderHelper;
...
namespace Trijinx.Graphics.OpenGL.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        {
            string scalingShader = EmbeddedResources.ReadAllText("Trijinx.Graphics.OpenGL/Effects/Shaders/fsr_scaling.glsl");
            string sharpeningShader = EmbeddedResources.ReadAllText("Trijinx.Graphics.OpenGL/Effects/Shaders/fsr_sharpening.glsl");
            string fsrA = EmbeddedResources.ReadAllText("Trijinx.Graphics.OpenGL/Effects/Shaders/ffx_a.h");
            string fsr1 = EmbeddedResources.ReadAllText("Trijinx.Graphics.OpenGL/Effects/Shaders/ffx_fsr1.h");
