...
namespace Trijinx.Horizon.Generators.Hipc
{
    [Generator]
    class HipcGenerator : ISourceGenerator
    {
        ...
        private const string TypeResult = "Trijinx.Horizon.Common.Result";
        private const string TypeBufferAttribute = "Trijinx.Horizon.Sdk.Sf.BufferAttribute";
        private const string TypeCopyHandleAttribute = "Trijinx.Horizon.Sdk.Sf.CopyHandleAttribute";
        private const string TypeMoveHandleAttribute = "Trijinx.Horizon.Sdk.Sf.MoveHandleAttribute";
        private const string TypeClientProcessIdAttribute = "Trijinx.Horizon.Sdk.Sf.ClientProcessIdAttribute";
        private const string TypeCommandAttribute = "Trijinx.Horizon.Sdk.Sf." + CommandAttributeName;
        private const string TypeIServiceObject = "Trijinx.Horizon.Sdk.Sf.IServiceObject";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (CommandInterface commandInterface in syntaxReceiver.CommandInterfaces)
            {
                ...
                generator.AppendLine("using Trijinx.Horizon.Common;");
                generator.AppendLine("using Trijinx.Horizon.Sdk.Sf;");
                generator.AppendLine("using Trijinx.Horizon.Sdk.Sf.Cmif;");
                generator.AppendLine("using Trijinx.Horizon.Sdk.Sf.Hipc;");
