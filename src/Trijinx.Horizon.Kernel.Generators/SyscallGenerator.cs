...
namespace Trijinx.Horizon.Kernel.Generators
{
    [Generator]
    class SyscallGenerator : ISourceGenerator
    {
        private const string ClassNamespace = "Trijinx.HLE.HOS.Kernel.SupervisorCall";
        ...
        private const string NamespaceKernel = "Trijinx.HLE.HOS.Kernel";
        private const string NamespaceHorizonCommon = "Trijinx.Horizon.Common";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            generator.AppendLine("using Trijinx.Common.Logging;");
            generator.AppendLine("using Trijinx.Cpu;");
