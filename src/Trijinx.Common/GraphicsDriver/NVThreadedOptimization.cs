using Trijinx.Common.GraphicsDriver.NVAPI;
using System;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;
// ReSharper disable InconsistentNaming

namespace Trijinx.Common.GraphicsDriver
{
    static partial class NVThreadedOptimization
    {
        private const string ProfileName = "Trijinx Nvidia Profile";
        ...
        public static void SetThreadedOptimization(bool enabled)
        {
            ...
            if (status != 0)
            {
                ...
                application.AppName.Set("Trijinx.exe");
                application.UserFriendlyName.Set("Trijinx");
