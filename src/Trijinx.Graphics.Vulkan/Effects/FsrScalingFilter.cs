...
namespace Trijinx.Graphics.Vulkan.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        public void Initialize()
        {
            ...
            byte[] scalingShader = EmbeddedResources.Read("Trijinx.Graphics.Vulkan/Effects/Shaders/FsrScaling.spv");
            byte[] sharpeningShader = EmbeddedResources.Read("Trijinx.Graphics.Vulkan/Effects/Shaders/FsrSharpening.spv");
