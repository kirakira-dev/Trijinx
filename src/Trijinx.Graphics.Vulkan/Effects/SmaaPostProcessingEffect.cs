...
using System;
using Format = Trijinx.Graphics.GAL.Format;
...
namespace Trijinx.Graphics.Vulkan.Effects
{
    internal class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        private void RecreateShaders(int width, int height)
        {
            ...
            byte[] edgeShader = EmbeddedResources.Read("Trijinx.Graphics.Vulkan/Effects/Shaders/SmaaEdge.spv");
            byte[] blendShader = EmbeddedResources.Read("Trijinx.Graphics.Vulkan/Effects/Shaders/SmaaBlend.spv");
            byte[] neighbourShader = EmbeddedResources.Read("Trijinx.Graphics.Vulkan/Effects/Shaders/SmaaNeighbour.spv");
        ...
        private void Initialize()
        {
            ...
            MemoryOwner<byte> areaTexture = EmbeddedResources.ReadFileToRentedMemory("Trijinx.Graphics.Vulkan/Effects/Textures/SmaaAreaTexture.bin");
            MemoryOwner<byte> searchTexture = EmbeddedResources.ReadFileToRentedMemory("Trijinx.Graphics.Vulkan/Effects/Textures/SmaaSearchTexture.bin");
