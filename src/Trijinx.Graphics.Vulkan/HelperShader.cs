...
using CompareOp = Trijinx.Graphics.GAL.CompareOp;
using Format = Trijinx.Graphics.GAL.Format;
using PrimitiveTopology = Trijinx.Graphics.GAL.PrimitiveTopology;
using SamplerCreateInfo = Trijinx.Graphics.GAL.SamplerCreateInfo;
using StencilOp = Trijinx.Graphics.GAL.StencilOp;
using Viewport = Trijinx.Graphics.GAL.Viewport;
...
namespace Trijinx.Graphics.Vulkan
{
    ...
    class HelperShader : IDisposable
    {
        ...
        private const string ShaderBinariesPath = "Trijinx.Graphics.Vulkan/Shaders/SpirvBinaries";
