...
APP_BUNDLE_DIRECTORY="$OUTPUT_DIRECTORY/Trijinx.app"
...
cp "$PUBLISH_DIRECTORY/Trijinx" "$APP_BUNDLE_DIRECTORY/Contents/MacOS/Trijinx"
chmod u+x "$APP_BUNDLE_DIRECTORY/Contents/MacOS/Trijinx"
...
cp Trijinx.icns "$APP_BUNDLE_DIRECTORY/Contents/Resources/Trijinx.icns"
...
python3 bundle_fix_up.py "$APP_BUNDLE_DIRECTORY" MacOS/Trijinx
